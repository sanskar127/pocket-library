...
const NotFound: FC<{ itemName: string }> = ({ itemName }) => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-dark text-white px-4">
            <div className="text-center">
                ...
                <h1 className="text-3xl font-bold mb-2">{itemName} Not Found</h1>
                <p className="text-lg text-gray-400 mb-6">The {itemName.toLowerCase()} you're looking for doesn't exist or has been removed.</p>
                <button
                    onClick={() => navigate(-1)}
